...
<body>
    ...
    <div>
        ...
        <p>
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ObjectDataSource1" GridLines="Horizontal" Height="50px" Width="491px">
            ...
            <asp:Button ID="btnBack" runat="server" PostBackUrl="~/Default.aspx" Text="&lt;&lt; Previous Page" />
        </p>
